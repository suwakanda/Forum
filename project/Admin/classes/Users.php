...
<strong>Error !</strong> Email already Exists, please try another Email... !</div>';
  ...
  public function selectCommentByid($blogid){
  ...
  public function CheckUserRole($email){
    $sql = "SELECT * FROM tbl_users WHERE email = :email and roleid = :roleid LIMIT 1";
    $stmt = $this->db->pdo->prepare($sql);
    $stmt->bindValue(':email', $email);
  ...
  <strong>Error !</strong> Email did not Found, use Register email or password please !</div>';
        ...
        $chkRole = $this->CheckUserRole($email);
    ...
    <strong>Error !</strong> Sorry, Your account is Diactivated, Contact with Admin !</div>';
            return $msg;
        }elseif($chkRole == FALSE){
          $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Error !</strong> Sorry, Your account is Not admin you cant login !</div>';
            return $msg;
        }elseif ($logResult) {
  ...
  <strong>Error !</strong> Invalid email address !</div>';
    ...
    //Delte Blog by id function
    public function deleteBlogById($remove){
      ...
      $stmt->bindValue(':id', $remove);
        ...
        if ($result) {
          $msg = '<div class="alert alert-success alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Success !</strong> Blog Deleted Successfully !</div>';
            return $msg;
        }else{
          $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    ...
    //Delte comment by id function
    public function deleteCommentById($remove){
      ...
      $stmt->bindValue(':id', $remove);
        ...
        if ($result) {
          $msg = '<div class="alert alert-success alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong>Success !</strong> Comment Deleted Successfully !</div>';
            return $msg;
        }else{
          $msg = '<div class="alert alert-danger alert-dismissible mt-3" id="flash-msg">
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
