        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          ...
          <?php if (Session::get('id') == TRUE) { ?>
            <?php if (Session::get('roleid') == '1') { ?>
              <li class="nav-item">
                  <a class="nav-link" href="aforum.php"><i class="fas fa-clipboard-list mr-2"></i>Forum </span></a>
            ...
            <li class="nav-item">
              <a class="nav-link" href="../home.php"><i class="fas fa-browser mr-2"></i>Back to forum</a>
            </li>
            <li class="nav-item">
